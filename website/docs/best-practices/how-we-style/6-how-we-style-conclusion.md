...
## Создайте свои стили {#byo-styles}
...
## Хуки pre-commit {#pre-commit-hooks}
...
## dbt Project Evaluator {#dbt-project-evaluator}
...
## Шаблон руководства по стилю {#style-guide-template}
