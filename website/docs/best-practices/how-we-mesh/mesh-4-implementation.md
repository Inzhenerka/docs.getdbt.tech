...
### С чего начать ваше путешествие в мир mesh? {#where-should-your-mesh-journey-start}
...
## Разделите ваши проекты {#defining-project-interfaces-with-groups-and-access}
...
## Подключение существующих проектов {#connecting-existing-projects}
...
### Наши примерные проекты {#our-example-projects}
