...
## Как создать семантическую модель {#how-to-build-a-semantic-model}
...
## Определение заказов {#defining-orders}
...
## Установление наших сущностей {#establishing-our-entities}
...
### Сущности в действии {#entities-in-action}
...
## Определение наших измерений {#defining-our-dimensions}
...
### Измерения в действии {#dimensions-in-action}
...
## Создание наших мер {#making-our-measures}
...
### Меры в действии {#measures-in-action}
...
## Проверка нашей работы {#reviewing-our-work}
