...
To fully experience the <Constant name="semantic_layer" />, including the ability to query dbt metrics via external integrations, you'll need a [<Constant name="cloud" /> Starter, Enterprise, or Enterprise plus accounts](https://www.getdbt.com/pricing/). Refer to [<Constant name="semantic_layer" /> FAQs](/docs/use-dbt-semantic-layer/sl-faqs) for more information.
:::
