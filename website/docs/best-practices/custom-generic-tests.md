...
### Универсальные тесты со стандартными аргументами {#generic-tests-with-standard-arguments}
...
### Добавление описания к логике обобщённого data-теста {#add-description-to-generic-data-test-logic}
...
### Обобщённые тесты с параметрами конфигурации по умолчанию {#generic-tests-with-additional-arguments}
...
### Настройка встроенных тестов dbt {#generic-tests-with-default-config-values}
...
### Примеры {#customizing-dbts-built-in-tests}
