...
### Запуск только изменённых моделей для тестирования изменений («slim CI»)
...
## Pro-tips для dbt-проектов
### Ограничивайте объём обрабатываемых данных в среде разработки
...
### Использование grants для управления привилегиями на объектах, создаваемых dbt
...
### Управление пробелами, генерируемыми Jinja
