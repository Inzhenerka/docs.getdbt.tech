...
# Как провести фантастическое выступление на митапе {#how-to-deliver-a-fantastic-meetup-talk}
...
## Понимание митапов dbt {#understanding-dbt-meetups}
...
## Признаки готовности к выступлению {#recognize-when-youre-ready-to-give-a-talk}
...
### Вы недавно завершили проект с высоким воздействием {#you-recently-finished-a-high-impact-project}
...
### Вы достигли переломного момента в карьере {#you-hit-an-inflection-point-in-your-career}
...
### Вы глубоко изучаете тему {#youre-digging-deep-into-a-topic}
...
### У вас есть сильное мнение о чем-то {#you-have-a-strong-opinion-about-something}
...
## Контрольный пункт: Может ли кто-то другой лучше провести это выступление? {#checkpoint-is-someone-else-well-placed-to-give-this-talk}
...
## Формирование вашего выступления {#shaping-your-talk}
...
## Основная структура {#the-basic-structure}
...
### Почему эта структура работает? {#why-does-this-structure-work}
...
## Примеры, следующие этой структуре {#examples-that-follow-this-structure}

Вот несколько наших любимых выступлений, соответствующих структуре — поверьте, это работает!

### Улучшение надежности данных — Андреа Копиц, Envoy {#improving-data-reliability-andrea-kopitz-envoy}
...
### Прогнозирование конверсий клиентов с использованием dbt + машинного обучения — Кенни Нинг, Better.com {#predicting-customer-conversions-with-dbt-machine-learning-kenny-ning-bettercom}
...
### Миграция 387 моделей с Redshift на Snowflake — Команда данных Bowery Farming {#migrating-387-models-from-redshift-to-snowflake-bowery-farming-data-team}
...
## Превратите это в презентацию {#turn-it-into-a-presentation}

Теперь пришло время взять вашу идею и превратить её в презентацию.

### Структурирование ваших слайдов {#structuring-your-slides}
...
### Сделайте вашу презентацию яркой {#making-your-presentation-shine}

При превращении вашей истории в презентацию также рассмотрите возможность выполнения следующих действий:

#### Используйте полные предложения в заголовках слайдов {#use-full-sentences-in-your-slide-headings}
...
#### Сделайте ваши слайды доступными {#make-your-slides-accessible}
...
#### Используйте доказательства в ваших слайдах {#use-evidence-in-your-slides}
...
#### (Виртуальные мероприятия) Создайте моменты для интерактивности {#virtual-events-create-moments-for-interactivity}
...
## Сопроводите это блог-постом {#pair-it-with-a-blog-post}
...
## Выступление на мероприятии, не связанном с dbt {#speaking-at-a-non-dbt-event}
...
### Вопросы, которые стоит задать организатору мероприятия {#questions-to-ask-the-event-organizer}

#### Каков технический уровень аудитории? {#what-is-the-technical-baseline-for-the-audience}
...
#### Какие выступления были наиболее успешными? {#what-kind-of-talks-have-been-the-most-successful}
...
#### Какова логистика мероприятия? {#what-are-the-event-logistics}
...
#### Есть ли возможность получить обратную связь по теме? {#is-there-an-opportunity-for-topic-feedback}
...
#### Есть ли дополнительные соображения по доступности, о которых вам следует знать? {#are-there-any-additional-accessibility-considerations-you-should-be-aware-of}
...
### Ответ на запрос конференции о выступлениях {#responding-to-a-conference-call-for-speakers}
