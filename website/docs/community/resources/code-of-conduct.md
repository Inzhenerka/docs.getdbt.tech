...
# Кодекс поведения сообщества dbt {#dbt-community-code-of-conduct}
...
## Ценности сообщества dbt {#dbt-community-values}
### Создавайте больше ценности, чем получаете. {#create-more-value-than-you-capture}
...
### Поощряйте разнообразие и участие. {#encourage-diversity-and-participation}
...
## Политика противодействия домогательствам {#anti-harassment-policy}
...
### Сообщение о домогательствах {#reporting-harassment}
...
## Coalesce и другие мероприятия {#coalesce-and-other-events}
