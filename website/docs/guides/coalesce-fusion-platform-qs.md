...
1. Go to [https://workshops.us1.dbt.com/workshop?id=46](https://workshops.us1.dbt.com)  
   Note: In order to access the sign-up page, you may need to log out of any existing dbt Platform account you have or access this URL in Incognitomode
...
6. Hover the asterisk in select \* to see column names and data types of available columns.   
   💡 *Fusion provides live metadata and column insights as you code.*

<Lightbox src="/img/guides/coalesce-fusion-qs/select-star.png" width="90%" title="Live metadata allows you to inspect the columns included in a select *." />
...
<Lightbox src="/img/guides/coalesce-fusion-qs/models-reused.png" width="90%" title="Observe how reusing models reduces warehouse costs and improves job speed." />

💡 *State aware orchestration ensures only changed data is processed.*
