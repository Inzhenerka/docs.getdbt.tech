...
## Обновление до последней версии dbt Core {#upgrade-to-the-latest-dbt-core-version}
...
### Шаг 1: Тестирование в разработке (с использованием override) {#step-1-test-in-development-using-override}
...
### Шаг 2: Обновление окружения разработки {#step-2-upgrade-your-development-environment}
...
### Шаг 3: Обновление staging и pre-production {#step-3-upgrade-staging-and-pre-production}
...
### Шаг 4: Обновление продакшн-окружения {#step-4-upgrade-your-production-environment}
...
### Шаг 5: Обновление jobs {#step-5-update-jobs}
...
## Устранение всех предупреждений об устаревании {#resolve-all-deprecation-warnings}
...
### Что обрабатывает инструмент autofix {#what-the-autofix-tool-handles}
...
### Шаг 1: Создание новой ветки {#step-1-create-a-new-branch}
...
### Шаг 2: Запуск инструмента autofix {#step-2-run-the-autofix-tool}
...
### Шаг 3: Просмотр и применение autofix {#step-3-review-and-apply-autofixes}
...
### Шаг 4: Проверка изменений {#step-4-verify-the-changes}
...
### Шаг 5: Коммит изменений {#step-5-commit-your-changes}
...
### Шаг 6: Устранение оставшихся устареваний {#step-6-address-remaining-deprecations}
...
### Шаг 7: Слияние с основной веткой {#step-7-merge-to-your-main-branch}
...
## Проверка и обновление dbt-пакетов {#validate-and-upgrade-your-dbt-packages}
...
### Шаг 1: Просмотр текущих пакетов {#step-1-review-your-current-packages}
...
### Шаг 2: Проверка совместимости и поиск последних версий пакетов {#step-2-check-compatibility-and-find-the-latest-package-versions}
...
### Шаг 3: Обновление версий пакетов {#step-3-update-your-package-versions}
...
### Шаг 4: Установка обновлённых пакетов {#step-4-install-updated-packages}
...
### Шаг 5: Тестирование проекта с обновлёнными пакетами {#step-5-test-your-project-with-updated-packages}
...
### Шаг 6: Коммит обновлений пакетов {#step-6-commit-package-updates}
...
## Проверка известных ограничений Fusion {#check-for-known-fusion-limitations}
...
### Шаг 1: Ознакомьтесь с таблицей ограничений {#step-1-review-the-limitations-table}
...
### Шаг 2: Поиск ограниченных функций в проекте {#step-2-search-your-project-for-limited-features}
...
### Шаг 3: Оценка влияния {#step-3-assess-the-impact}
...
### Шаг 4: Формирование плана действий {#step-4-create-an-action-plan}
...
### Шаг 5: Документирование результатов {#step-5-document-your-findings}
...
### Шаг 6: Отслеживание прогресса функций {#step-6-track-feature-progress}
