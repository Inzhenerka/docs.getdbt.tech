...
## Миграция конфигураций метрик на новую спецификацию {#migrate-metric-configs-to-the-new-spec}
...
## Аудит значений метрик после миграции {#audit-metric-values-after-the-migration}
...
## Настройка семантического слоя в новой среде {#setup-the-semantic-layer-in-a-new-environment}
...
## Обновление подключения в интеграциях нижнего уровня {#update-connection-in-downstream-integrations}
...
### Руководство по миграции для Mode {#migration-guide-for-hex}
...
## Слияние вашей ветки миграции метрик в основную и обновление вашей производственной среды до версии 1.6 {#merge-your-metrics-migration-branch-to-main-and-upgrade-your-production-environment-to-16}
