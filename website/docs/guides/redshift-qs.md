...
7. Select your project using the Redshift connection. 
...
9. Set your development credentials. These credentials will be used by <Constant name="cloud" /> to connect to Redshift. Those credentials (as provided in your CloudFormation output) will be:
...
10. Click **Test connection**. This verifies that <Constant name="cloud" /> can access your Redshift cluster.
11. If the test succeeded, you can set up a repository. If it failed, you might need to check your Redshift settings and credentials.
