...
### Раскрытие метаданных для dbt Labs {#exposing-metadata-to-dbt-labs}
...
## Используйте лучшие практики при раскрытии метрик {#use-best-practices-when-exposing-metrics}
...
### Управление и отслеживаемость {#governance-and-traceability}
...
### Контекст и интерпретация {#query-flexibility}
...
### Прозрачность и использование компиляции {#context-and-interpretation}
...
### Где фильтры и оптимизация {#transparency-and-using-compile}
...
## Понимание этапов интеграции {#understand-stages-of-an-integration}
