...
Материализации отвечают за создание новых таблиц или <Term id="view">представлений</Term> в базе данных, или вставку/обновление/удаление данных из существующих таблиц. Таким образом, материализации должны знать о состоянии базы данных, чтобы определить, какой именно SQL они должны выполнить. Вот некоторый псевдокод для фазы "настройки" материализации **<Term id="table" />**:
