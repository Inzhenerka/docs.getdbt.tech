...
## Создание материализации {#creating-a-materialization}
...
### Структура материализации {#anatomy-of-a-materialization}
...
### Подготовка базы данных {#prepare-the-database}
...
### Запуск pre-hooks {#run-pre-hooks}
...
### Запуск post-hooks {#run-post-hooks}
...
### Обновление кеша Relation {#update-the-relation-cache}
...
## Конфигурация материализации {#materialization-configuration}
...
### Указание параметров конфигурации {#specifying-configuration-options}
...
## Приоритет материализации {#materialization-precedence}
