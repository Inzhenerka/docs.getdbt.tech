...
## Миграция вашего существующего SQL-кода {#migrate-your-existing-sql-code}
...
## Создание источников из ссылок на таблицы {#create-sources-from-table-references}
...
#### Отчетность о свежести источников {#source-freshness-reporting}
...
#### Легкое отслеживание зависимостей {#easy-dependency-tracing}
...
#### Привычка аналитики как кода {#build-the-habit-of-analytics-as-code}
...
#### Параллельный рефакторинг {#alongside-refactoring}
...
## Реализация группировок CTE {#implement-cte-groupings}
...
#### 2. Логические CTE {#2-logical-ctes}
...
#### 4. Простой оператор SELECT {#4-simple-select-statement}
...
## Перенос CTE в отдельные модели данных {#port-ctes-to-individual-data-models}
...
### Определение моделей стадий {#identifying-staging-models}
...
### CTE или промежуточные модели {#ctes-or-intermediate-models}
...
## Аудит модели данных {#data-model-auditing}
...
### Готовы к практике рефакторинга? {#ready-for-refactoring-practice}
