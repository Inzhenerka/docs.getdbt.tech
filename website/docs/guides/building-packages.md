...
We also recommend ensuring your package is compatible with [<Constant name="fusion"/>](/docs/fusion) and [<Constant name="core"/>](/docs/about-dbt-install). To ensure <Constant name="fusion"/> compatibility, you can follow the steps in the [Fusion compatibility guide](/guides/fusion-package-compat).
