...
### Оцените, является ли пакет правильным решением {#assess-whether-a-package-is-the-right-solution}
...
## Создайте новый проект {#create-your-new-project}
...
## Разработайте ваш пакет {#develop-your-package}
...
### Обеспечьте совместимость с Fusion {#ensure-fusion-compatibility}
...
### Следуйте лучшим практикам {#follow-best-practices}
...
### Сделайте местоположение необработанных данных настраиваемым {#make-the-location-of-raw-data-configurable}
_Только для пакетов моделирования_
...
### Установите пакеты upstream с hub.getdbt.com {#install-upstream-packages-from-hubgetdbtcom}
...
### Реализуйте кросс-базовую совместимость {#implement-cross-database-compatibility}
...
### Используйте специфичные имена моделей {#use-specific-model-names}
_Только для пакетов моделирования_
...
### По умолчанию используйте представления {#default-to-views}
_Только для пакетов моделирования_
...
### Тестируйте и документируйте ваш пакет {#test-and-document-your-package}
...
### Включите полезные артефакты GitHub {#include-useful-github-artifacts}
...
## Добавьте интеграционные тесты {#add-integration-tests}
_Опционально_
...
## Разверните документацию для вашего пакета {#deploy-the-docs-for-your-package}
_Опционально_
...
## Выпустите ваш пакет {#release-your-package}
...
## Добавьте пакет на hub.getdbt.com {#add-the-package-to-hubgetdbtcom}
