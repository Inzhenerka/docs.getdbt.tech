...
### Что вы будете использовать во время лабораторной работы {#what-youll-use-during-the-lab}
...
### Что вам нужно знать {#what-you-need-to-know}
...
## Настройка Snowflake {#configure-snowflake}
...
## Подключение к источнику данных {#connect-to-data-source}
...
## Изменение имени схемы разработки и навигация по IDE {#change-development-schema-name-and-navigate-the-ide}
...
## Создание ветки и настройка конфигураций проекта {#create-branch-and-set-up-project-configs}
...
## Создание папок и организация файлов {#create-folders-and-organize-files}
...
## Создание источников и моделей подготовки {#create-source-and-staging-models}
...
### 1. Создание источников {#1-create-sources}
...
### 2. Создание моделей подготовки {#2-create-staging-models}
...
## Преобразование SQL {#transform-sql}
...
### Промежуточные модели {#intermediate-models}
...
## Запуск моделей dbt Python {#running-dbt-python-models}
...
### Анализ пит-стопов {#pit-stop-analysis}
...
### Модель dbt, функции .source(), .ref() и .config() {#the-dbt-model-source-ref-and-config-functions}
