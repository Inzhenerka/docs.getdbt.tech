...
SQL linting in CI lints all the changed SQL files in your project (compared to the last deferred production state). Available on <Constant name="cloud" /> [Starter, Enterprise, or Enterprise plus accounts](https://www.getdbt.com/pricing) using [release tracks](/docs/dbt-versions/cloud-release-tracks). 
