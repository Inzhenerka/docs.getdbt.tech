...
## Компоненты платформы {#platform-components}
...
### Определение размера ваших SQL-складов {#sizing-your-sql-warehouses}
...
### Предоставление складов по рабочей нагрузке {#provision-warehouses-by-workload}
...
### Настройка автоостановки {#configure-auto-stop}
...
## Шаблоны и лучшие практики {#patterns-best-practices}
...
### Бронзовый / Слой подготовки: {#bronze-staging-layer}
...
### Серебряный / Промежуточный слой {#silver-intermediate-layer}
...
### Компактация файлов {#file-compaction}
...
### Золотой / Слой витрин {#gold-marts-layer}
...
### Фильтрация строк в целевом и/или исходном {#filter-rows-in-target-andor-source}
...
## Устранение неполадок производительности {#performance-troubleshooting}
...
### Профиль запроса SQL-склада {#sql-warehouse-query-profile}
...
### Неэффективное обрезание файлов {#inefficient-file-pruning}
...
### Полные сканирования таблиц {#full-table-scans}
...
### Взрывающиеся объединения {#exploding-joins}
...
### Лучшие практики материализации {#materialization-best-practices}
...
### dbt Discovery API {#dbt-discovery-api}
