...
### Staging layer
Теперь, когда базовая структура проекта настроена, можно приступать к созданию дата-ассетов. Настройте staging-слой следующим образом:

1. Создайте новый YAML‑файл свойств `models/staging/sources.yml`.
2. Опишите источники данных, скопировав следующий код в файл и нажав **Save**.
...
1. В файле `models/core/core.yml` добавьте директиву `access: public` в соответствующий YAML‑файл свойств, добавив и сохранив следующее:
...
1. Создайте новый файл свойств `models/staging/sources.yml` и объявите источники, скопировав следующий фрагмент в файл и нажав **Save**.
