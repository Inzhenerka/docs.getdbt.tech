...
5. dbt Cloud automatically enables query history for brand new environments. If query history fails to retrieve data, dbt Cloud disables it to prevent unintended warehouse costs. You’ll need to manually re-enable it once you resolve the issue.
