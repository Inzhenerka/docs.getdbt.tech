...
- For the upstream ("producer") project setup:
  ...
  - If changes have been made, ensure that the deployment job run generates an updated [manifest.json](/reference/artifacts/manifest-json) file, as this is necessary for downstream projects to reference the latest changes.
