...
- **Visualize downstream exposures** &mdash; [Set up](/docs/cloud-integrations/auto-exposures-tableau) and [visualize downstream exposures](/docs/collaborate/view-auto-exposures) to automatically expose relevant data models from Tableau to enhance visibility.
