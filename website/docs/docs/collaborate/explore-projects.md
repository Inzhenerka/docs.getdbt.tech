...
- **Auto-exposures** &mdash; [Set up](/docs/cloud-integrations/auto-exposures-tableau) and [view auto-exposures](/docs/collaborate/view-auto-exposures) to automatically expose relevant data models from Tableau to enhance visibility.
