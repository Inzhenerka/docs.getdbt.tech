...
- **Auto-exposures** &mdash; [Set up and view auto-exposures](/docs/cloud-integrations/active-and-auto-exposures) to automatically expose relevant data models from Tableau to enhance visibility.
