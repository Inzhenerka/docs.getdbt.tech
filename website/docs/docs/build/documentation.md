...
dbt provides multiple ways to generate documentation:
- **dbt Docs**: Generates a static website with model lineage, metadata, and documentation. Available on dbt Core or dbt Cloud Developer plans. 
- **dbt Explorer**: A dynamic, real-time interface in dbt Cloud with richer metadata, customizable views, deep insight into your project, and collaboration tools. Available on dbt Cloud Team or Enterprise plans.

For more details on how to generate and view documentation, see [Generate and view documentation](/docs/build/generate-documentation).
