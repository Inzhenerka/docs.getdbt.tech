...
- [**<Constant name="explorer" />**](/docs/collaborate/explore-projects): Builds upon dbt Docs to provide a dynamic, real-time interface with enhanced metadata, customizable views, deeper project insights, and collaboration tools. Available on <Constant name="cloud" /> [Starter, Enterprise, or Enterprise Plus plans](https://www.getdbt.com/pricing).
