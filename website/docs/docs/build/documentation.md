...
dbt provides a scalableway to [generate](#generating-documentation) documentation for your dbt project using descriptions and commands. The documentation for your project includes:
...
- [**dbt Docs**:](/docs/build/generate-documentation#dbt-docs) Generates a static website with model lineage, metadata, and documentation that can be hosted on S3, Netlify, or your own web server. Available on dbt Core or dbt Cloud Developer plans.
