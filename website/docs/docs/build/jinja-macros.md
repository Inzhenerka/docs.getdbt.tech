...
### Использование макроса из пакета {#using-a-macro-from-a-package}
...
### Используйте макросы из пакетов {#leverage-package-macros}
...
### Устанавливайте переменные в начале модели {#set-variables-at-the-top-of-a-model}
