...
## Как использовать пользовательские схемы? {#how-do-i-use-custom-schemas}
...
## Понимание пользовательских схем {#understanding-custom-schemas}
...
### Как dbt генерирует имя схемы модели? {#how-does-dbt-generate-a-models-schema-name}
...
## Изменение способа генерации имени схемы в dbt {#changing-the-way-dbt-generates-a-schema-name}
...
### Аргументы generate_schema_name {#generateschemaname-arguments}
...
### Контекст Jinja, доступный в generate_schema_name {#jinja-context-available-in-generateschemaname}
...
### Какие переменные доступны в generate_schema_name? {#which-vars-are-available-in-generateschemaname}
...
### Управление различными поведениями в разных пакетах {#managing-different-behaviors-across-packages}
...
## Встроенный альтернативный шаблон для генерации имен схем {#a-built-in-alternative-pattern-for-generating-schema-names}
