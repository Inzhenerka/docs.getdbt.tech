...
You can create new projects and [share them](/docs/cloud/git-version-control) with other people by making them available on a hosted git repository like GitHub, GitLab, and BitBucket.
