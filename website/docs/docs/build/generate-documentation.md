...
* **Team collaboration**: Use [dbt Explorer](#dbt-explorer) to [generate](#generating-project-documentation) and view documentation in dbt Cloud that contains interactive metadata and lineage. Available for dbt Cloud Team and Enterprise plans.
...
Generate and view documentation in a couple of ways:
