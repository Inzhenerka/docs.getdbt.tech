...
## Как работает параллельное выполнение батчей {#how-parallel-batch-execution-works}
...
## Параллельное или последовательное выполнение {#parallel-or-sequential-execution}
...
## Конфигурация `concurrent_batches` {#configure-concurrent_batches}
