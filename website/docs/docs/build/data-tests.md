...
## Единичные тесты данных {#singular-data-tests}
...
## Общие тесты данных {#generic-data-tests}
...
### Больше общих тестов данных {#more-generic-data-tests}
...
## Хранение результатов неудачных тестов данных {#storing-data-test-failures}
