...
## Начало работы с хуками и операциями {#getting-started-with-hooks-and-operations}
...
### Примеры использования хуков {#examples-using-hooks}
...
### Вызов макроса в хуке {#calling-a-macro-in-a-hook}
