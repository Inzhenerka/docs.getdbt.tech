...
intro_text: "Используйте инкрементальные модели микробатчей для эффективной обработки больших наборов данных временных рядов."
---
...
## Что такое "microbatch" в dbt? {#what-is-microbatch-in-dbt}
...
## Как работает микробатч {#how-microbatch-works}
...
### Поведение, зависящее от адаптера {#adapter-specific-behavior}
...
## Соответствующие конфигурации {#relevant-configs}
...
### Обязательные конфигурации для конкретных адаптеров {#required-configs-for-specific-adapters}
...
#### Отказ от автофильтрации {#opting-out-of-auto-filtering}
...
## Заполнения пропусков {#backfills}
...
## Сравнение microbatch с другими инкрементальными стратегиями {#timezones}
