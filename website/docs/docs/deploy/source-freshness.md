...
### Включение снимков актуальности источников {#enabling-source-freshness-snapshots}
...
### Частота снимков актуальности источников {#source-freshness-snapshot-frequency}
