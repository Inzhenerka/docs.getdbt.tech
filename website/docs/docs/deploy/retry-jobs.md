...
4. Examine the error message and determine how to fix it. After you have made your changes, save and commit them to your [<Constant name="git" /> repo](/docs/cloud/git-version-control).
