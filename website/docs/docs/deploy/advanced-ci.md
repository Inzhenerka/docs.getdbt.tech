...
# Продвинутый CI <Lifecycle status="managed,managed_plus" /> {#advanced-ci}
...
### Оптимизация сравнений {#optimizing-comparisons}
...
## О кэшированных данных {#about-the-cached-data}
...
## Разрешения на подключение {#connection-permissions}
