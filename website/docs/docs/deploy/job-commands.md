...
## Типы команд job {#job-command-types}
...
### Команды-чекбоксы {#checkbox-commands}
...
#### Кастомные команды для Compare changes {#compare-changes-custom-commands}
...
## Ошибки выполнения job commands {#job-command-failures}
