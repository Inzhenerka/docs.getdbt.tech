...
- [Auto and active exposures](/docs/deploy/active-and-auto-exposures) &mdash; Learn how to use dbt Cloud to automatically generate exposures from dashboards and proactively refresh the underlying data sources (like Tableau extracts) during scheduled dbt jobs.
