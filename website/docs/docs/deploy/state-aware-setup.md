...
- **Execution settings** section:
     ...
     - **Enable Fusion cost optimization features**: Enable this option to enable both **State-aware orchestration** and **Efficient testing**. You can expand **More options** to enable or disable individual settings. 
- **Triggers** section:
