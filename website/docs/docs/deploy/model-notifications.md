...
## Настройка групп {#configure-groups}
...
## Привязка групп к моделям {#attach-groups-to-models}
...
## Включение доступа к уведомлениям о моделях {#enable-access-to-model-notifications}
