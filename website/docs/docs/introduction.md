...
### Платформа dbt (dbt Cloud) {#the-dbt-platform-formerly-dbt-cloud}
...
### Движок dbt Fusion {#the-dbt-fusion-engine}
...
## dbt оптимизирует ваш рабочий процесс {#dbt-optimizes-your-workflow}
...
## dbt обеспечивает более надежный анализ {#dbt-provides-more-reliable-analysis}
