...
- If you're on the <Constant name="dbt_platform" />, you can [upgrade to the <Constant name="fusion_engine" />](/docs/dbt-versions/upgrade-dbt-version-in-cloud#dbt-fusion-engine) to power your projects. <Constant name="fusion"/> in the <Constant name="dbt_platform" /> is available in private preview. Contact your account team for access. <Lifecycle status="private_preview" /> 
