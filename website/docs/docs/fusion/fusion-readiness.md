...
3. [ ] **Validate and upgrade your dbt packages:** Make sure that all of your packages are upgraded to the most recent version, which for many of them contains enhancements to support <Constant name="fusion" />. 
...
6. [ ] **Stay informed about Fusion progress:** The <Constant name="fusion_engine" /> remains in private preview and we currently offer it for eligible projects! We will notify you when all your projects are ready for <Constant name="fusion" /> based on our eligibility checks on your deployment jobs. In the meantime, keep up-to-date with these resources: 
    ...
    3. [ ] Monitor progress and get insight into the development process by reading the [Fusion Diaries](https://github.com/dbt-labs/dbt-fusion/discussions/categories/announcements).
