...
## Подготовка к Fusion {#preparing-for-fusion}

Используйте следующий чеклист, чтобы подготовить ваши проекты к <Constant name="fusion_engine" />.

### 1. Обновитесь до последней версии dbt {#1-upgrade-to-the-latest-dbt-version}
...
### 2. Устраните все предупреждения о депрекациях {#2-resolve-all-deprecation-warnings}
...
### 3. Проверьте и обновите dbt-пакеты {#3-validate-and-upgrade-your-dbt-packages}
...
### 4. Проверьте известные ограничения Fusion {#4-check-for-known-fusion-limitations}
...
### 5. Проверьте задания, настроенные в dbt platform {#5-review-jobs-configured-in-the-dbt-platform}
...
### 6. Следите за развитием Fusion {#6-stay-informed-about-fusion-progress}
