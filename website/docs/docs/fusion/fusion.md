...
- [Upgrade to the <Constant name="fusion_engine" />](/docs/dbt-versions/upgrade-dbt-version-in-cloud#dbt-fusion-engine) to power your projects in the <Constant name="dbt_platform" />, available in private preview. Contact your account team for access. <Lifecycle status="private_preview" /> 
