...
## Обзор семантического слоя dbt {#overview-of-the-dbt-semantic-layer}
...
## Как работает семантический слой dbt? {#how-does-the-dbt-semantic-layer-work}
...
## Создание метрик и семантических моделей {#build-metrics-and-semantic-models}
