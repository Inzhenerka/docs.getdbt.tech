...
Most data platforms support reading from other catalogs, but generally do not support writes. This is changing rapidly, and we will adjust our documentation as platforms implement updates to their capabilities. 
