...
## Создание Iceberg-таблиц {#creating-iceberg-tables}
...
## Iceberg-каталоги {#iceberg-catalogs}
...
### Внешние каталоги {#external-catalogs}
...
#### Материализация таблиц в Snowflake {#table-materialization-in-snowflake}
...
## Конфигурации интеграции каталога dbt для Snowflake {#dbt-catalog-integration-configurations-for-snowflake}
...
#### Примеры конфигураций {#example-configurations-1}
