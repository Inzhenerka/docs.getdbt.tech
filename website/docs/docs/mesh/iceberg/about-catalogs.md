...
## О каталогах данных {#about-data-catalogs}
...
### История каталогов данных {#history-of-data-catalogs}
...
### Почему каталоги данных важны для dbt {#why-data-catalogs-are-important-to-dbt}
...
## О каталогах Iceberg {#about-iceberg-catalogs}
...
### Как dbt работает с каталогами Iceberg {#how-dbt-works-with-iceberg-catalogs}
