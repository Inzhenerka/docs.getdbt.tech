...
## Создание таблиц Iceberg {#creating-iceberg-tables}
...
## Каталоги BigQuery Iceberg {#bigquery-iceberg-catalogs}
...
### Конфигурации интеграции каталога dbt для BigQuery {#dbt-catalog-integration-configurations-for-bigquery}
...
### Настройка интеграции каталога для управляемых таблиц Iceberg {#configure-catalog-integration-for-managed-iceberg-tables}
...
### Параметр base_location {#base-location}
...
#### Примеры конфигурации {#example-configurations}
