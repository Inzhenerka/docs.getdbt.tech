...
### Как доступ к моделям соотносится с разрешениями базы данных? {#how-does-model-access-relate-to-database-permissions}
...
### Как я могу сослаться на модель из другого проекта? {#how-do-i-ref-a-model-from-another-project}
...
### Как я могу ограничить доступ к моделям, определенным в пакете? {#how-do-i-restrict-access-to-models-defined-in-a-package}
