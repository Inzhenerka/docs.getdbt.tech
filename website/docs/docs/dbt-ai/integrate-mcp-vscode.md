---
title: "Integrate VSCode with MCP"
sidebar_label: "Integrate VSCode with MCP"
description: "Guide to set up VSCode with dbt-mcp"
id: "integrate-vscode-mcp"
---

# Integrate VSCode with dbt MCP server
...
![mcp-vscode-settings](website/static/img/mcp/vscode_mcp_enabled_image.png "mcp-vscode-settings")
...
- Running the `MCP: List Servers` command from the Command Palette (Control/Command + Shift + P) and selecting the server. The output should look something like this: 

![vscode-output](website/static/img/mcp/vscode_run_server_output.png "VsCode Output")
- Utlizing the keywords inline within the `mcp.json` file

![inline-management](website/static/img/mcp/vscode_run_server_keywords_inline.png "Vscode inline management")
