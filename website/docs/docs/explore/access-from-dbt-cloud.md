...
#### Доступ к Catalog из IDE {#access-catalog-from-the-ide}
...
#### Доступ к Catalog из вкладки lineage {#access-catalog-from-the-lineage-tab}
...
### Вкладка Model timing в jobs <Lifecycle status="self_service,managed,managed_plus"/> {#model-timing-tab-in-jobs}
...
#### Доступ к Catalog из вкладки model timing {#access-catalog-from-the-model-timing-tab}
...
### dbt Insights <Lifecycle status="managed,managed_plus" /> {#dbt-insights}
