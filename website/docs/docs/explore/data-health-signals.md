...
# Сигналы здоровья данных <Lifecycle status="preview" /> {#data-health-signals}
...
## Доступ к сигналам здоровья данных {#access-data-health-signals}
...
## Критерии сигналов здоровья данных {#data-health-signal-criteria}
