...
## Настройка задания для документации {#set-up-a-documentation-job}
...
### Настройка документации проекта {#configure-project-documentation}
...
### Просмотр документации {#view-documentation}
