...
### Значение threads по умолчанию изменено на 4 {#threads-default-value-changed-to-4}
...
### Создание нового job больше не запускает выполнение по умолчанию {#creating-a-new-job-no-longer-triggers-a-run-by-default}
...
### Приватные пакеты должны клонироваться с использованием access token, переданных через переменные окружения {#private-packages-must-be-cloned-using-access-tokens-provided-by-environment-variables}
...
## Ноябрь 2022 {#november-2022}

### Опыт работы с dbt Cloud + Databricks становится еще лучше {#the-dbt-cloud-databricks-experience-is-getting-even-better}
...
### Дополнительные возможности в новом и обновленном IDE {#extra-features-in-new-and-refreshed-ide}
...
### Уведомление о выводе из эксплуатации Classic IDE {#classic-ide-deprecation-notice}
...
### Анонс нативной интеграции dbt Cloud с Azure DevOps {#announcing-dbt-clouds-native-integration-with-azure-devops}
...
### Представляем более быстрый, улучшенный и мощный Cloud IDE {#introducing-a-snappier-improved-and-powerful-cloud-ide}
...
### Предупреждение о выводе из эксплуатации API endpoint List Steps {#list-steps-api-endpoint-deprecation-warning}
...
### Запрос данных за последние три месяца через metadata API {#query-the-previous-three-months-of-data-using-the-metadata-api}
...
### Поддержка cross-database sources на инстансах Redshift RA3 {#support-for-cross-database-sources-on-redshift-ra3-instances}
...
### Функция Large DAG {#large-dag-feature}
...
### Обновление просроченных access token в IDE при использовании GitLab {#refresh-expired-access-tokens-in-the-ide-when-using-gitlab}
...
### Учетные данные больше не удаляются при редактировании окружения {#credentials-no-longer-accidentally-wiped-when-editing-an-environment}
...
### Улучшения производительности планировщика {#scheduler-performance-improvements}
...
### Нестабильное интернет-соединение больше не вызывает сообщение о завершении сессии {#spotty-internet-issues-no-longer-cause-a-session-time-out-message}
...
### Разделение queue time на waiting time и prep time {#dividing-queue-time-into-waiting-and-prep-time}
...
### Обновления DAG и улучшения производительности {#dag-updates-and-performance-improvements}
...
#### Улучшения и оптимизации производительности {#performance-improvements-and-enhancements}
...
### Service tokens и исправления ошибок {#service-tokens-and-bug-fixes}
...
#### Новые продукты и возможности {#new-products-and-features}
...
## Январь 2022 {#january-2022}

### Сниппеты автодополнения для SQL и YAML файлов в IDE {#autocomplete-snippets-for-sql-and-yaml-files-in-ide}
...
#### Улучшения и оптимизации производительности {#performance-improvements-and-enhancements-1}
...
### Model timing для Multi-tenant Team и Enterprise аккаунтов {#model-timing-for-multi-tenant-team-and-enterprise-accounts}
...
#### Улучшения и оптимизации производительности {#performance-improvements-and-enhancements-2}
