...
- To gain access to the **Latest Fusion** release track, you must contact your dbt Labs account team to request it. Week by week, we'll expand the beta cohort based on project eligibility, including the Starter plan. Once we transition from Beta to Preview, all accounts will see it as an option for their environments, projects, jobs, etc.
