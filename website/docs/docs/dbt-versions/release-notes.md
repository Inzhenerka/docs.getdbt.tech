...
- **Enhancement:** Users assigned IT [licenses](/docs/cloud/manage-access/seats-and-users) can now edit and manager adapter [connections settings](/docs/cloud/connect-data-platform/about-connections#connection-management).
