...
## December 2025
- **Enhancement**:  SSO slugs are now system generated during SSO setup and aren't customizable. SSO slug configurations that are currently in use will continue to be valid, however they will be read-only and it won't be possible to change them. If you delete your existing SSO configuration and create a new one, you'll be provided with a new system generated SSO slug. This enahances security and prevents accounts from setting slugs that "impersonate" other organizations.
