...
- **New**: With Hybrid projects, your organization can adopt complementary dbt Core and dbt Cloud workflows and seamlessly integrate these workflows by automatically uploading dbt Core artifacts into dbt Cloud. [Hybrid projects](/docs/deploy/hybrid-projects) is now available as a preview. 
