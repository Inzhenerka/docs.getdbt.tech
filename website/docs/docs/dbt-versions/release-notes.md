...
- **New**: Bring your own [Azure OpenAI key](/docs/cloud/enable-dbt-copilot#bringing-your-own-openai-api-key-byok) for dbt Copilot is now generally available. Organizations can configure dbt Copilot to use their own Azure OpenAI keys, giving you more control over data governance and billing.
