...
- **New**: [Auto exposures](/docs/cloud-integrations/auto-exposures) are now generally available to dbt Cloud Enterprise plans. Auto-exposures integrate natively with Tableau (Power BI coming soon) and auto-generate downstream lineage in dbt Explorer for a richer experience.
...
<Expandable alt_header="Coalesce 2024 announcements">
  ...
  - [Auto-exposures with Tableau](/docs/cloud-integrations/auto-exposures)
