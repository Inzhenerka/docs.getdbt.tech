...
### Продвинутая и экспериментальная функциональность {#advanced-and-experimental-functionality}
...
### Для пользователей конкретных адаптеров {#for-users-of-specific-adapters}
