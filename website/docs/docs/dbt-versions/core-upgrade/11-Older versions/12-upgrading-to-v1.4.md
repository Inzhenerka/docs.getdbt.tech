...
### Расширенные конфигурации для инкрементальных моделей {#advanced-configurations-for-incremental-models}
...
### Обновления для Python моделей {#updates-to-python-models}
