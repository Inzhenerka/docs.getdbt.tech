...
# Обновление до dbt utils v1.0 {#upgrading-to-dbt-utils-v10}
...
### Изменения в `surrogate_key()`: {#changes-to-surrogate_key}
...
### Функциональность, которая теперь встроена в dbt Core: {#functionality-now-native-to-dbt-core}
...
### Удаление материализации `insert_by_period` {#removal-of-insertbyperiod-materialization}
...
```
### Удаление устаревшего поведения: {#removal-of-deprecated-legacy-behavior}
...
## Решение сообщений об ошибках {#resolving-error-messages}
