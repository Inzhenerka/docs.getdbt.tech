...
### Для пользователей артефактов dbt (метаданные) {#for-consumers-of-dbt-artifacts-metadata}
...
## Для разработчиков адаптеров {#for-maintainers-of-adapter-plugins}
...
## Новая и измененная функциональность {#new-and-changed-functionality}
...
### Специфические адаптеры {#specific-adapters}
