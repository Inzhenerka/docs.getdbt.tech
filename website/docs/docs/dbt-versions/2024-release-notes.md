...
- **New**: [Downstream exposures](/docs/cloud-integrations/auto-exposures-tableau) are now generally available to dbt Cloud Enterprise plans. Downstream exposures integrate natively with Tableau (Power BI coming soon) and auto-generate downstream lineage in dbt Explorer for a richer experience.
...
<Expandable alt_header="Coalesce 2024 announcements">
  ...
  - [Downstream exposures with Tableau](https://docs.getdbt.com/docs/collaborate/view-auto-exposures)
