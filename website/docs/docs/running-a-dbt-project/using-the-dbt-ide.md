...
- The dbt IDE is powered by [dbt-rpc](/reference/commands/rpc). You must be on a [supported version](/docs/dbt-versions/upgrade-dbt-version-in-cloud) of dbt to take full advantage of features and functionality.
