...
## Что такое виртуальное окружение Python? {#what-is-a-python-virtual-environment}
...
### Настройка виртуального окружения Python {#set-up-a-python-virtual-environment}
...
### Деактивация виртуального окружения {#deactivate-virtual-environment}
...
### Создание alias {#create-an-alias}
...
## Установка адаптера {#installing-the-adapter}
...
### Обновление адаптеров {#upgrade-adapters}
...
### Установка только dbt-core {#install-dbt-core-only}
...
## Изменение версий dbt Core {#change-dbt-core-versions}
...
## `pip install dbt` {#pip-install-dbt}
...
## Установка prerelease-версий {#installing-prereleases}
...
## Активация виртуальной среды {#activate-your-virtual-environment}
