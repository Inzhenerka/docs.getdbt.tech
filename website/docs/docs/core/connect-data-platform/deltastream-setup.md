...
## Подключение к DeltaStream с помощью **dbt-deltastream** {#connecting-to-deltastream-with-dbt-deltastream}
...
### Описание полей профиля DeltaStream {#description-of-deltastream-profile-fields}
...
## Устранение проблем с подключением {#troubleshooting-connections}

Если у вас возникают проблемы с подключением к DeltaStream из dbt, проверьте следующее:

### Проблемы с аутентификацией {#authentication-issues}
