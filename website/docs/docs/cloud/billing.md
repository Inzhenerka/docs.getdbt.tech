...
## Как работает ценообразование dbt? {#how-does-dbt-pricing-work}
...
### Что считается лицензией (seat)? {#what-counts-as-a-seat-license}
...
### Что считается успешно построенной моделью? {#what-counts-as-a-successful-model-built}
...
### Что считается запрошенной метрикой? {#what-counts-as-a-queried-metric}
...
### Просмотр использования в продукте {#viewing-usage-in-the-product}
...
## dbt Copilot: учёт и ограничения использования <Lifecycle status="Starter, Enterprise, Enterprise+" /> {#dbt-copilot-usage-metering-and-limiting}
...
### Информация об использовании и учёте {#usage-and-metering-information}
...
### Просмотр использования в продукте {#viewing-usage-in-the-product-1}
...
## Планы и биллинг {#plans-and-billing}
...
### Биллинг плана Developer {#developer-plan-billing}
...
### Биллинг плана Starter {#starter-plan-billing}
...
### Биллинг плана Enterprise {#enterprise-plan-billing}
...
## Управление использованием {#managing-usage}
...
### Уведомления об использовании {#usage-notifications}
...
### Как остановить начисление использования? {#how-do-i-stop-usage-from-accruing}
...
## Оптимизация затрат в dbt {#optimize-costs-in-dbt}

<Constant name="cloud" /> предоставляет способы оптимизировать количество построенных моделей и затраты на хранилище данных. 

### Лучшие практики оптимизации успешно построенных моделей {#best-practices-for-optimizing-successful-models-built}
...
#### Исключение views в задании dbt {#exclude-views-in-a-dbt-job}
...
#### Исключение views при запуске тестов {#exclude-views-while-running-tests}
...
#### Сборка только изменённых views {#build-only-changed-views}
...
### Оптимизация неэффективных моделей {#rework-inefficient-models}

#### Вкладка Job Insights {#job-insights-tab}
...
#### Вкладка Model Timing {#model-timing-tab}
