...
# Настройка ограничений по IP <Lifecycle status="managed_plus" /> {#configuring-ip-restrictions}
...
## Настройка ограничений по IP {#configuring-ip-restrictions-1}
...
### Блокировка IP (запрет) {#blocking-ips-deny}
...
## Включение ограничений {#enabling-restrictions}
