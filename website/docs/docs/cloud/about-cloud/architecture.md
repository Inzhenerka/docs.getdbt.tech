...
## Об архитектуре dbt {#about-dbt-architecture}
...
### Взаимодействие с хранилищем данных {#data-warehouse-interaction}
...
### Сервисы аутентификации {#authentication-services}
