...
# Основы управления версиями {#version-control-basics}
...
## Кнопка git в облачной IDE {#the-git-button-in-the-cloud-ide}
...
## Файл .gitignore {#the-gitignore-file}
