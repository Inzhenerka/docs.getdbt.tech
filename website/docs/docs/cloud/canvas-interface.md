...
# Навигация по интерфейсу <Lifecycle status='managed, managed_plus'/> {#navigate-the-interface}
...
## Панель конфигурации {#configuration-panel}
