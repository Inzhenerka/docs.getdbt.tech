...
5. Click the box for **Show advanced options** and then click **Edit attribute list for customappsso**.
...
6. Scroll to the bottom of the **Edit attribute list** window and there will be an empty field where you can add a new entry. Enter the following fields: 
...
10. Back on the **Attribute mapping** screen, click the checkbox to **Show advanced options**
    <Lightbox src="/img/docs/dbt-cloud/access-control/show-advanced-options.png" width="60%" title="Edit the advanced options." />
11. Mark all of the fields from Step 5 as `Required` and click **Save**.
