...
## Управление типами лицензий {#managing-license-types}
...
### Настройка через маппинг <Lifecycle status="managed,managed_plus" /> {#mapped-configuration}
...
## Детализированное управление правами {#granular-permissioning}
