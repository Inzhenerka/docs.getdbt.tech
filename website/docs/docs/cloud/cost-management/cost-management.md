...
The Cost Management dashboard and features are only available to customers in the US on AWS at this time. Support for more regions and providers is being rolled out over the coming months.
