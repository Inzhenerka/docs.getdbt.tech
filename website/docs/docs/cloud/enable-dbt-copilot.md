...
- <Constant name="copilot" /> is optimized for OpenAI's gpt-3.x, gpt-4o, gpt-4.1-[mini|nano], gpt-4.5 (deprecated by OpenAI) models. Using other models (like o1 and o2) can affect performance and accuracy, and functionality with other models isn't guaranteed.
