...
- [Generate SQL expressions for models](#generate-sql-expressions-for-models) &mdash; Use dbt Copilot to generate SQL expressions for models in the [Visual Editor](/docs/cloud/use-visual-editor).
...
## Generate SQL expressions for models
