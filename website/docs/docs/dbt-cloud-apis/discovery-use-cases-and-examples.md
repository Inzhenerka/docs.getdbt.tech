...
### Сколько времени заняло выполнение каждой модели? {#how-long-did-each-model-take-to-run}
...
### Каково последнее состояние каждой модели? {#whats-the-latest-state-of-each-model}
...
### Что произошло с моим выполнением задания? {#what-happened-with-my-job-run}
...
### Что изменилось с последнего выполнения? {#whats-changed-since-the-last-run}
...
### Какие модели и тесты не прошли выполнение? {#which-models-and-tests-failed-to-run}
...
### Когда данные, используемые моей моделью, были обновлены в последний раз? {#when-was-the-data-my-model-uses-last-refreshed}
...
### Свежи ли мои источники данных? {#are-my-data-sources-fresh}
...
### Каково покрытие тестами и их статус? {#whats-the-test-coverage-and-status}
...
### Как эта модель контрактируется и версионируется? {#how-is-this-model-contracted-and-versioned}
...
### Что означает этот набор данных и его столбцы? {#what-does-this-dataset-and-its-columns-mean}
...
### Какова полная линия данных? {#whats-the-full-data-lineage}
...
### Как выглядит полная линейность данных на уровне моделей? {#whats-the-full-data-lineage-at-a-model-level}
...
### Какие метрики доступны? {#which-metrics-are-available}
...
### Кто отвечает за эту модель? {#who-is-responsible-for-this-model}
...
### Кто может использовать эту модель? {#who-can-use-this-model}
...
### Как эта модель или метрика используется в инструментах downstream? {#how-is-this-model-or-metric-used-in-downstream-tools}
...
### Как эта модель изменилась со временем? {#how-has-this-model-changed-over-time}
...
### Какие узлы зависят от этого источника данных? {#which-nodes-depend-on-this-data-source}
