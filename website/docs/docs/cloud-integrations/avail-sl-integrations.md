...
- [Exports](/docs/use-dbt-semantic-layer/exports) use exports with BI tools with the <Constant name="semantic_layer" />, even if you don’t have a native integration.
