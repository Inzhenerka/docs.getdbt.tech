...
## Как использовать функцию AVG {#how-to-use-the-avg-function}
...
### Пример использования функции AVG {#avg-function-example}
...
## Синтаксис функции SQL AVG в Snowflake, Databricks, BigQuery и Redshift {#sql-avg-function-syntax-in-snowflake-databricks-bigquery-and-redshift}
...
## Примеры использования функции AVG {#avg-function-use-cases}
