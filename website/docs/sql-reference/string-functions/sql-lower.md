...
## Как использовать функцию SQL LOWER {#how-to-use-the-sql-lower-function}
...
### Пример функции SQL LOWER {#sql-lower-function-example}
...
## Синтаксис функции SQL LOWER в Snowflake, Databricks, BigQuery и Redshift {#sql-lower-function-syntax-in-snowflake-databricks-bigquery-and-redshift}
...
## Примеры использования функции LOWER {#lower-function-use-cases}
