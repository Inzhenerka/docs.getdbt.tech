...
## Как создать полное внешнее соединение {#how-to-create-a-full-outer-join}
...
### Пример полного внешнего соединения SQL {#sql-full-outer-join-example}
...
## Примеры использования полного внешнего соединения SQL {#sql-full-outer-join-use-cases}
