...
## Как создавать SQL комментарии {#how-to-create-sql-comments}
...
### Пример SQL комментария {#sql-comment-example}
...
## SQL комментарии в Snowflake, Databricks, BigQuery и Redshift {#sql-comments-in-snowflake-databricks-bigquery-and-redshift}
...
## Лучшие практики по SQL комментариям {#sql-commenting-best-practices}
