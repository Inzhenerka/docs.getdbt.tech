...
In dbt-databricks v1.10, there are several new model configurations options that are gated behind the `use_materialization_v2` flag.
For full details, see the [documentation of Databricks behavior flags](/docs/reference/global-configs/databricks-changes.md).
