...
### Материализация представления {#view-materialization}
...
### Материализация таблицы {#table-materialization}
...
#### Конфигурация инкрементальной таблицы {#incremental-table-configuration}
