...
### Источники данных (sources) {#sources}
...
### Материализация таблиц {#table-materialization}
...
## Правила именования и обязательные конфигурации {#naming-rules-and-required-configs}
