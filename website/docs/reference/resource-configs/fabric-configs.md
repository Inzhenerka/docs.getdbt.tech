...
## Клонирование таблиц {#table-clone}
...
## Права с автоматическим предоставлением {#grants-with-auto-provisioning}
...
### Merge (по умолчанию) {#merge-default}
...
## Ссылки между хранилищами {#cross-warehouse-references}
...
## Снимки хранилища {#warehouse-snapshots}
