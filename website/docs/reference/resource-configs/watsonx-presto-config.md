...
## Требования к экземпляру {#instance-requirements}
...
### Конфигурация Hive {#hive-configuration}
...
### Конфигурация Iceberg {#iceberg-configuration}
...
#### Ограничения для некоторых коннекторов {#limitations-with-some-connectors}
