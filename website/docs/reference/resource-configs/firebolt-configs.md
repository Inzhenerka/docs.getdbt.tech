...
## Конфигурация модели для таблиц фактов {#model-configuration-for-fact-tables}
...
#### Конфигурации таблиц фактов {#fact-table-configurations}
...
#### Пример таблицы фактов с агрегирующим индексом {#example-of-a-fact-table-with-an-aggregating-index}
...
## Конфигурация модели для таблиц измерений {#model-configuration-for-dimension-tables}
...
#### Конфигурации таблиц измерений {#dimension-table-configurations}
...
## Как именуются агрегирующие индексы {#how-aggregating-indexes-are-named}
...
## Управление загрузкой через внешние таблицы {#managing-ingestion-via-external-tables}

`dbt-firebolt` поддерживает [функцию внешних таблиц](https://docs.getdbt.tech/reference/resource-properties/external) dbt, которая позволяет dbt управлять процессом загрузки таблиц из S3 в Firebolt. Это необязательная функция, но она может быть очень удобной в зависимости от вашего случая использования.
...
#### Установка пакета внешних таблиц {#installation-of-external-tables-package}
...
#### Использование внешних таблиц {#using-external-tables}
...
#### Синтаксис dbt_project.yml для внешней таблицы {#dbt_projectyml-syntax-for-an-external-table}
...
#### Запуск внешних таблиц {#running-external-tables}
...
## Поведение семян {#seeds-behavior}
