...
## Примеры {#examples}
### Использование столбца `id` в качестве уникального ключа {#use-an-id-column-as-a-unique-key}
...
### Использование нескольких уникальных ключей {#use-multiple-unique-keys}
