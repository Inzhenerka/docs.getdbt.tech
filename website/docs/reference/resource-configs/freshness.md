...
id: "freshness"
---
# freshness <Lifecycle status="private_preview,managed,managed_plus" /> {#freshness}
...
### Более редкая сборка {#less-frequent}
...
### Более частая сборка {#more-frequent}
...
### Произвольная частота сборки {#custom-frequency}
