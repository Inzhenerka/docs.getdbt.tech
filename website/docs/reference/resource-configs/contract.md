...
## Алиасинг типов данных {#data-type-aliasing}
...
## Размер, точность и масштаб {#size-precision-and-scale}
...
### Инкрементальные модели и `on_schema_change` {#incremental-models-and-onschemachange}
