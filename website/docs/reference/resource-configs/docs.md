...
## Примеры {#examples}
### Пометить модель как скрытую {#mark-a-model-as-hidden}
...
### Пометить подкаталог моделей как скрытый {#mark-a-subfolder-of-models-as-hidden}
...
## Пользовательские цвета узлов {#custom-node-colors}
