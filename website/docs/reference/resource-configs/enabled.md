...
## Примеры {#examples}
### Отключение модели в пакете для использования вашей собственной версии модели. {#disable-a-model-in-a-package-in-order-to-use-your-own-version-of-the-model}
