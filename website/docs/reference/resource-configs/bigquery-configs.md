...
## Использование `project` и `dataset` в конфигурациях {#use-project-and-dataset-in-configurations}
...
## Использование партиционирования и кластеризации таблиц {#using-table-partitioning-and-clustering}

### Предложение PARTITION {#partition-clause}
...
#### Партиционирование по дате или timestamp {#partitioning-by-a-date-or-timestamp}
...
#### Партиционирование по дате или timestamp загрузки (ingestion) {#partitioning-by-an-ingestion-date-or-timestamp}
...
#### Партиционирование с использованием целочисленных диапазонов {#partitioning-with-integer-buckets}
...
#### Дополнительные настройки партиционирования {#additional-partition-configs}
...
### Предложение CLUSTERING {#clustering-clause}
...
## Управление шифрованием KMS {#managing-kms-encryption}
...
### Использование KMS‑шифрования {#using-kms-encryption}
...
## Labels и tags {#labels-and-tags}

### Задание labels {#specifying-labels}
...
### Применение labels к заданиям (jobs) {#applying-labels-to-jobs}
...
#### Настройка tags в файле модели {#configuring-tags-in-a-model-file}
...
#### Настройка tags в `dbt_project.yml` {#configuring-tags-in-dbt_projectyml}
...
#### Совместное использование dbt tags и BigQuery tags {#using-both-dbt-tags-and-bigquery-tags}
...
## Поведение merge (инкрементальные модели) {#merge-behavior-incremental-models}
...
### Производительность и стоимость {#performance-and-cost}
...
#### Определение партиций для перезаписи {#determining-partitions-to-overwrite}
...
#### Статические партиции {#static-partitions}
...
#### Динамические партиции {#dynamic-partitions}
...
#### Копирование партиций {#copying-partitions}
...
## Управление сроком хранения таблиц {#controlling-table-expiration}
...
## Авторизованные представления (Authorized views) {#authorized-views}
...
## Материализованные представления (Materialized views) {#materialized-views}
...
### Автообновление (Auto-refresh) {#auto-refresh}
...
## Конфигурация Python-моделей {#python-model-configuration}
...
## Ограничения unit-тестов {#unit-test-limitations}
