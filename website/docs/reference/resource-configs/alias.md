...
Specify a custom alias for a model in your project file (`dbt_project.yml`), properties file (for example, `models/properties.yml`) config, or in a SQL file config.
...
Configure a snapshots's alias in your project file (`dbt_project.yml` ), properties file config (for example, `snapshots/snapshot_name.yml`) file, or in the SQL file config for the model.
...
Configure a data test's alias in your project file (`dbt_project.yml` ), properties file (for example, `models/properties.yml`) file, or in the SQL file config for the model.
