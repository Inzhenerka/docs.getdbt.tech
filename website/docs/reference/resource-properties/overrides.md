...
## Примеры {#examples}
### Укажите имя вашей базы данных и схемы для источника, определенного в пакете {#supply-your-database-and-schema-name-for-a-source-defined-in-a-package}
...
### Настройте свою собственную свежесть источника для таблицы источника в пакете {#configure-your-own-source-freshness-for-a-source-table-in-a-package}
