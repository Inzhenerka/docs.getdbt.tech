...
## Готовые тесты данных {#out-of-the-box-data-tests}
...
### Тестирование выражения {#test-an-expression}
...
### Использование пользовательского обобщённого (generic) теста данных {#use-custom-generic-data-test}
...
### Пользовательское имя теста данных {#custom-data-test-name}
...
### Альтернативный формат для определения тестов {#alternative-format-for-defining-tests}
