...
### data_type (обязательно) {#data_type-required}
...
### Простая скалярная функция {#simple-scalar-function}
...
### Функция со сложным типом возвращаемого значения {#function-with-complex-return-type}
...
### Функция BigQuery с типом возвращаемого значения ARRAY {#bigquery-function-with-array-return-type}
