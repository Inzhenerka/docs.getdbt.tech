...
### Добавление простого описания для модели и колонки {#add-a-simple-description-to-a-model-and-column}
...
### Добавление многострочного описания к модели {#add-a-multiline-description-to-a-model}
...
### Использование markdown в описании {#use-some-markdown-in-a-description}
...
### Использование блока docs в описании {#use-a-docs-block-in-a-description}
...
### Включение изображения из вашего репозитория в ваши описания {#include-an-image-from-your-repo-in-your-descriptions}
...
### Включение изображения из интернета в ваши описания {#include-an-image-from-the-web-in-your-descriptions}
...
### Добавление описания к data test {#add-a-description-to-a-data-test}

Вы можете добавить свойство `description` к generic или singular data test.

#### Generic data test {#generic-data-test}
...
#### Singular data test {#singular-data-test}
...
### Добавление описания к unit test {#add-a-description-to-a-unit-test}
