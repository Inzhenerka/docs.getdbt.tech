...
---
## Альтернативный синтаксис конфигурации SQL-файлов {#alternative-sql-file-config-syntax}
...
<!---
## Иерархии / переопределение конфигураций / приоритеты {#hierarchies-overriding-configs-precedence}
Для Drew
--->