...
#### Избегайте неограниченных верхних границ {#avoid-unbounded-upper-limits}
...
## Совместимость с Fusion {#fusion-compatibility}
...
### Указать минимальную версию dbt {#specify-a-minimum-dbt-version}
...
### Закрепить диапазон {#pin-to-a-range}
...
### Требование к конкретной версии dbt {#require-a-specific-dbt-version}
...
## Недопустимые версии dbt {#invalid-dbt-versions}
...
## Отключение проверки версий {#disabling-version-checks}
