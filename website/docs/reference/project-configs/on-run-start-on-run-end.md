...
## Примечания по использованию {#examples}
...
### Предоставление привилегий на все схемы, которые использует dbt, в конце выполнения {#grant-privileges-on-all-schemas-that-dbt-uses-at-the-end-of-a-run}
...
### Вызов макроса для предоставления привилегий {#call-a-macro-to-grant-privileges}
