...
## Использование синтаксиса словаря {#using-the-dictionary-syntax}
...
### Добавить статический комментарий в начало {#prepend-a-static-comment}
...
### Отключить комментарии запросов {#disable-query-comments}
...
### Добавить динамический комментарий в начало {#prepend-a-dynamic-comment}
...
### Добавить комментарий по умолчанию в конец {#append-the-default-comment}
...
### BigQuery: включение элементов комментария запроса в job labels {#bigquery-include-query-comment-items-as-job-labels}
...
### Добавить пользовательский комментарий в конец {#append-a-custom-comment}
...
### Средний уровень: использование макроса для генерации комментария {#intermediate-use-a-macro-to-generate-a-comment}
...
### Продвинутый уровень: использование макроса для генерации комментария {#advanced-use-a-macro-to-generate-a-comment}
...
## Контекст компиляции {#compilation-context}
