...
2. Review the logs:
   - If you see warnings, you have warnings that aren’t currently handled by `--warn-error`/`--warn-error-options`. Continue to the next step.
   - If there are no warnings, proceed to enable the flag in the next step.
