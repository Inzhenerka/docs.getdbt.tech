...
Starting from dbt v1.9 (and also versionless in dbt Cloud), you can add [descriptions](/reference/resource-properties/data-tests#description) to both generic and singular tests.
