...
## Продвинутое использование ref {#advanced-ref-usage}

### Версионированный ref {#versioned-ref}
...
### Ссылка на модели из конкретных проектов {#ref-project-specific-models}
...
### Принудительное задание зависимостей {#forcing-dependencies}
