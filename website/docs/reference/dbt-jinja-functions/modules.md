...
:::info Note
Starting with `dbt-core==1.10.6`, usage of `modules.itertools` will raise a deprecation warning. For more information and suggested workarounds, please refer to the [documentation on `ModulesItertoolsUsageDeprecation`](/reference/deprecations/modules-itertools-usage-deprecation).
:::
