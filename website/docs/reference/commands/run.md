...
### Как работает `dbt run`? {#how-does-dbt-run-work}
...
## Обновление инкрементальных моделей {#refresh-incremental-models}
...
## Запуск конкретных моделей {#running-specific-models}
...
## Обработка предупреждений как ошибок {#treat-warnings-as-errors}

См. [глобальные конфигурации](/reference/global-configs/warnings)

## Быстрое завершение при ошибках {#failing-fast}

См. [глобальные конфигурации](/reference/global-configs/failing-fast)

## Включение или отключение цветных логов {#enable-or-disable-colorized-logs}
