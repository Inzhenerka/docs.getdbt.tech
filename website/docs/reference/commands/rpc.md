...
### Перечисление ресурсов проекта ([документация](/reference/commands/cmd-docs#dbt-docs-generate))
...
### Генерация документации ([документация](/reference/commands/cmd-docs#dbt-docs-generate))
