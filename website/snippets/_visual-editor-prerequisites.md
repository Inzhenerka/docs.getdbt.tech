...
- You must have read-only access to the [Staging environment](/docs/deploy/deploy-environments#staging-environment) with the data to be able to execute "run" in the visual editor. To customize the required role for the visual editor, refer to [Set up environment-level permissions](/docs/cloud/manage-access/environment-permissions-setup) for more information.
