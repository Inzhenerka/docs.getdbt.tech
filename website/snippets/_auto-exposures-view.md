...
2. From the **Overview** page, you can view auto-exposures from a couple of places:
   ...
   <Lightbox src="/img/docs/cloud-integrations/auto-exposures/explorer-view-resources.jpg" width="100%" title="View from the dbt Explorer under the 'Resources' menu."/>
   ...
   <Lightbox src="/img/docs/cloud-integrations/auto-exposures/explorer-view-file-tree.jpg" width="100%" title="View from the dbt Explorer under the 'File tree' menu."/>
