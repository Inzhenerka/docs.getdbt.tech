...
| Documentation | - Каждая модель имеет [description](https://docs.getdbt.com/reference/resource-properties/description). <br /> - Процент моделей, у которых есть описание, больше или равен заданному порогу. |
...
| Performance | - Каждая модель, которая напрямую используется в [exposure](https://docs.getdbt.com/docs/build/exposures), материализуется как <Term id="table" />.<br /> - Ни одна модель не зависит от цепочек «не физически материализованных» моделей длиной больше заданного порога. |
