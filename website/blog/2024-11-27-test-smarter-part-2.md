...
## Где должны находиться тесты в вашем конвейере? {#where-should-tests-go-in-your-pipeline}
...
### Промежуточный (если применимо) {#intermediate-if-applicable}
...
## Подводя итоги {#wrapping-it-all-up}
