...
## Developer experience в dbt до эпохи Fusion {#the-dbt-developer-experience-in-the-pre-fusion-era}
...
## Новая эра разработки с dbt {#the-new-era-of-dbt-development}
...
### Отлов SQL‑ошибок в реальном времени {#catch-sql-errors-in-real-time}
...
### Lineage моделей и колонок {#model-and-column-lineage}
...
## Заключение: новый стандарт {#conclusion-a-new-default}
