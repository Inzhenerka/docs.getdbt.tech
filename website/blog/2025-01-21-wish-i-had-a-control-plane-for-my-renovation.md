...
- **Проактивное планирование**: в dbt вы заранее объявляете желаемое [state](https://docs.getdbt.com/reference/node-selection/state-selection) ваших данных ещё до запуска джобов &mdash; архитектурные планы встроены непосредственно в pipeline.
- **Ретроспективные инсайты**: dbt Cloud предоставляет [job logs](https://docs.getdbt.com/docs/deploy/run-visibility), метрики производительности и результаты тестов, обеспечивая тот же уровень наблюдаемости, что и традиционные инструменты мониторинга.
