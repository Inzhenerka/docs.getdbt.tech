...
## Во многом это отражает то, как работают data pipelines {#in-many-ways-this-mirrors-how-data-pipelines-operate}
...
## Чем dbt Cloud отличается {#what-makes-dbt-cloud-different}
...
## Почему я хотел бы иметь control plane для моего ремонта {#why-i-wish-i-had-a-control-plane-for-my-renovation}
