...
## Шаг 1: Решите, до какой версии вы обновляетесь {#step-1-decide-which-version-you-are-upgrading-to}
...
## Шаг 2: Добавьте `require-dbt-version` в ваш файл `dbt_project.yml`. {#step-2-add-require-dbt-version-to-your-dbt_projectyml-file}
...
## Шаг 3: Обновите dbt {#step-3-upgrade-dbt}
...
## Шаг 4: Попробуйте запустить `dbt compile` {#step-4-try-to-run-dbt-compile}
...
## Шаг 5: Обработайте любые устаревшие функции {#step-5-handle-any-deprecations}
...
### Шаг 5a. Обновите ваши пакеты {#step-5a-update-your-packages}
...
### Шаг 5b. Исправьте ошибки, затем предупреждения {#step-5b-fix-errors-then-warnings}
...
### Оставайтесь сосредоточенными {#stay-focused}
...
### Шаг 5c. Повторяйте {#step-5c-rinse-and-repeat}
...
## Шаг 6. Тестируйте и проверяйте {#step-6-test-and-review}
...
## Шаг 7. Объедините и сообщите {#step-7-merge-and-communicate}
