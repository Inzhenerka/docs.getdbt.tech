...
## Почему стоит сосредоточиться на git {#why-we-should-focus-on-git}
...
## ⭐️ Как «просто начать» ⭐️ {#how-to-just-get-started}
...
## Прямое продвижение (Direct promotion) {#direct-promotion}
...
### Как выглядит workflow разработки для команды? {#how-does-the-development-workflow-look-to-a-team}
...
### Правила ветвления и вспомогательные механизмы репозитория {#repository-branching-rules-and-helpers}
...
### Процессы и окружения dbt Cloud {#dbt-cloud-processes-and-environments}
...
### Организация платформы данных {#data-platform-organization}
...
### Пример direct promotion {#direct-promotion-example}
...
## Косвенное продвижение (Indirect Promotion) {#indirect-promotion}
...
### Как выглядит рабочий процесс разработки глазами разработчика? {#how-does-the-development-workflow-look-to-a-developer}
...
### Правила ветвления в репозитории и вспомогательные настройки {#repository-branching-rules-and-helpers-1}
...
### Процессы и окружения dbt Cloud {#dbt-cloud-processes-and-environments-1}
...
### Организация платформы данных {#data-platform-organization-1}
...
### Пример косвенного продвижения (Indirect Promotion) {#indirect-promotion-example}
...
## Что изменило косвенное продвижение? {#what-did-indirect-promotion-change}
...
## Сравнение стратегий ветвления {#comparing-branching-strategies}
...
# Дальнейшие улучшения {#further-enhancements}
...
# Часто задаваемые вопросы про Git {#frequently-asked-git-questions}
