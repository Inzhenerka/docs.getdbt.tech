...
## Шаг 1: Подготовка базы данных {#step-1-database-preparation}
...
### Маскирование ролей {#role-masking}
...
## Шаг 2: Подготовка репозитория {#step-2-repository-preparation}
...
### Среда конвейера: requirements.txt {#pipeline-environment-requirementstxt}
...
### Подключения к базе данных: profiles.yml {#database-connections-profilesyml}
...
### Сам конвейер: bitbucket-pipelines.yml {#pipeline-itself-bitbucket-pipelinesyml}
...
### Непрерывное развертывание: Преобразование по последнему мастеру и сохранение артефактов {#continuous-deployment-transform-by-latest-master-and-keep-the-artifacts}
...
### Упрощенная непрерывная интеграция: Извлечение артефактов и выполнение на основе состояния {#slim-continuous-integration-retrieve-the-artifacts-and-do-a-state-based-run}
...
## Шаг 3: Подготовка среды Bitbucket {#step-3-bitbucket-environment-preparation}
...
### Аутентификация базы данных {#database-authentication}
...
### Аутентификация Bitbucket Downloads {#bitbucket-downloads-authentication}
...
### Включение Bitbucket Pipelines {#enable-bitbucket-pipelines}
...
## Шаг 4: Тестирование {#step-4-test}
