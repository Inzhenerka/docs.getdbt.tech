...
## Что такое понимание SQL? {#what-is-sql-comprehension}
...
## Уровни понимания SQL {#the-levels-of-sql-comprehension}
...
## Можно увидеть пример? {#can-i-see-an-example}
...
### Уровень 1: Parsing {#level-1-parsing}
...
### Уровень 2: Compiling {#level-2-compiling}
...
### Уровень 3: Executing {#level-3-executing}
...
## А теперь давайте всё сломаем {#so-lets-break-things}
...
### Parser (уровень 1): выявление синтаксических ошибок {#parser-level-1-capture-syntax-errors}
...
### Compiler (уровень 2): выявление ошибок компиляции {#compiler-level-2-capture-compilation-errors}
...
### Executor (уровень 3): выявление ошибок данных {#executor-level-3-capture-data-errors}
