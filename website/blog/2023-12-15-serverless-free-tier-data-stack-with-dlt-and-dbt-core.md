...
## Проблема, разработчик и инструменты {#the-problem-the-builder-and-tooling}
...
<!-- truncate -->
## Начальная точка {#the-starting-point}
...
### Загрузка данных {#ingesting-the-data}
...
### Трансформация данных {#transforming-the-data}
...
### Подготовка конвейера к производству {#production-readying-the-pipeline}
...
## Извлеченные уроки и заключение {#learnings-and-conclusion}
