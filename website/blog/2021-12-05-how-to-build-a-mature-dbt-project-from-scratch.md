...
# Создание зрелого проекта dbt с нуля {#building-a-mature-dbt-project-from-scratch}
...
## Предостережения и предположения {#caveats-and-assumptions}
...
## Уровень 1 - Младенчество - Запуск вашей первой модели {#level-1-infancy-running-your-first-model}
...
## Уровень 2 - Детство - Создание модульных моделей данных {#level-2-toddlerhood-building-modular-data-models}
...
## Уровень 3 - Детство - Разработка стандартов для совместной работы с кодом и поддерживаемости {#level-3-childhood-developing-standards-for-code-collaboration-and-maintainability}
...
## Уровень 4 - Подростковый возраст - Увеличение гибкости {#level-4-adolescence-increasing-flexibility}
...
## Уровень 5 - Взрослость - Укрепление отношений {#level-5-adulthood-solidifying-relationships}
