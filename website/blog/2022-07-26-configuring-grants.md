...
## Решение тогда {#the-solution-then}
...
### Почему `grants` лучше, чем хуки {#why-grants-are-better-than-hooks}
...
#### Решение сегодня {#the-solution-today}
...
## Есть ли еще место для хуков? {#is-there-still-a-place-for-hooks}
...
### Предоставление разрешений на другие типы объектов {#granting-permissions-on-other-object-types}
...
#### Вариант A: простой и знакомый {#option-a-simple-and-familiar}
...
#### Вариант B: Слишком хитро {#option-b-too-clever-by-half}
...
### Расширенные разрешения (или другие операции) {#advanced-permissions-or-other-operations}
...
### Предостережения и компромиссы оригинальных рекомендаций {#caveats-and-trade-offs-of-the-original-guidance}
`on-run-end` хуки:
...
### Проблемы, связанные с хуками {#issues-related-to-hooks}
