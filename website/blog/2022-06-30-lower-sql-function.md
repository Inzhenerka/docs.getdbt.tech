...
## Как использовать функцию LOWER {#how-to-use-the-lower-function}
...
### Поддержка функции LOWER в хранилищах данных {#data-warehouse-support-for-the-lower-function}
...
## Пример использования функции LOWER в SQL {#lower-sql-function-example}
