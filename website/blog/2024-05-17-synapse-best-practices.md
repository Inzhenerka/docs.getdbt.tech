...
## Лучшие практики для Fabric {#fabric-best-practices}
...
## Fabric — это будущее {#fabric-is-the-future}
...
## Предоставление ресурсов {#resource-provisioning}
...
### минимизация пулов; максимизация DWU {#minimize-pools-maximize-dwus}
...
#### количество пулов {#number-of-pools}
...
### Ресурсы для развертывания {#deployment-resources}
...
#### разрешения для аналитиков {#permissions-for-analytics-engineers}
...
#### разрешения сервисного принципала {#service-principal-permissions}
...
## Соображения по моделированию {#model-considerations}
...
### распределения и индексы {#distributions-indices}
...
## Развертывания и экосистема {#deployments-ecosystem}
...
### Потребители нижнего уровня (Power BI) {#downstream-consumers-power-bi}
