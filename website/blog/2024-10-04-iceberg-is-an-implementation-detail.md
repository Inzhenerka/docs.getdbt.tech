...
## Что такое Iceberg? {#what-is-iceberg}
...
## Просто еще одна деталь реализации {#just-another-implementation-detail}
...
## Иногда детали действительно важны {#sometimes-the-details-do-matter}
...
## dbt как слой абстракции {#dbt-the-abstraction-layer}
