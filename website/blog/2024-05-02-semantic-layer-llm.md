...
## Зачем это строить {#why-build-this}
...
### Получение семантики {#retrieving-semantics}
...
### Создание примеров {#creating-examples}
...
### Разбор структурированного объекта {#structured-object-parsing}
