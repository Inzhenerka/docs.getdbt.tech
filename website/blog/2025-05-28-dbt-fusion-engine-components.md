...
## Какие варианты движка dbt Fusion существуют? {#what-variants-of-the-dbt-fusion-engine-exist}

### Source-available версия движка dbt Fusion {#source-available-dbt-fusion-engine}
...
### Предсобранный бинарник движка dbt Fusion {#precompiled-dbt-fusion-engine-binary}
...
### Использование движка dbt Fusion по коммерческому соглашению {#using-the-dbt-fusion-engine-with-a-commercial-agreement}
...
## Другие элементы мозаики {#other-pieces-of-the-puzzle}

Движок dbt Fusion — это главный герой, но лежащие в его основе технологии можно комбинировать самыми разными способами.

### Расширение dbt для VS Code и Language Server {#the-dbt-vs-code-extension-and-language-server}
...
### Authoring Layer dbt {#the-dbt-authoring-layer}
...
### Адаптеры движка dbt Fusion {#dbt-fusion-engine-adapters}
...
### Грамматики ANTLR {#antlr-grammars}
...
## Как можно взаимодействовать с этими компонентами? {#how-do-i-engage-with-these-components}
