...
## Что такое Remote dbt MCP Server? <Lifecycle status="self_service,managed,managed_plus,beta" /> {#what-is-the-remote-dbt-mcp-server}
...
## Архитектура Remote dbt MCP Server {#the-remote-dbt-mcp-server-architecture}
...
## Remote dbt MCP Server в действии {#the-remote-dbt-mcp-server-in-action}
