...
## Как использовать функцию DATEDIFF {#how-to-use-the-datediff-function}
...
### DATEDIFF в Snowflake, Amazon Redshift и Databricks {#datediff-in-snowflake-amazon-redshift-and-databricks}
...
### DATEDIFF в Google BigQuery {#datediff-in-google-bigquery}
...
## Герой в тени: макрос DATEDIFF в dbt! {#a-hero-in-the-shadows-the-datediff-dbt-macro}
