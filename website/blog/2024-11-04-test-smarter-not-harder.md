...
## Зачем тестирование? {#why-testing}
...
## Выявление проблем качества данных в вашем конвейере {#identifying-data-quality-issues-in-your-pipeline}
...
### Категория 1: Гигиена данных {#bucket-1-data-hygiene}

Проблемы *гигиены данных* — это проблемы, которые вы решаете на [этапе подготовки данных.](https://docs.getdbt.tech/best-practices/how-we-structure/2-staging) Гигиеничные данные соответствуют вашим ожиданиям в отношении форматирования, полноты и требований к детализации. Вот несколько примеров.
...
### Категория 2: Аномалии, ориентированные на бизнес {#bucket-2-business-focused-anomalies}
...
### Категория 3: Аномалии, ориентированные на статистику {#bucket-3-stats-focused-anomalies}
...
## Как приоритизировать проблемы качества данных в вашем конвейере {#how-to-prioritize-data-quality-concerns-in-your-pipeline}
...
### Начните свой план действий {#start-your-action-plan}
