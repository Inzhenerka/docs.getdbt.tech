...
## С чего мы начали {#where-we-started}
...
## Проблема масштабируемости {#the-scalability-problem}
...
## Решение: dbt Squared {#the-solution-dbt-squared}

### Технологии и люди {#technology-and-people}
...
### Поток настройки проекта {#project-setup-flow}
...
### Поток разработки {#development-flow}
