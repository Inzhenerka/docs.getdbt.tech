...
## Что такое первичный ключ? {#whats-a-primary-key}
...
## Зачем мы тестируем первичные ключи? {#why-do-we-test-primary-keys}
...
## Как тестировать первичные ключи с помощью dbt {#how-to-test-primary-keys-with-dbt}
...
## Поддерживает ли ваше хранилище первичные ключи? {#does-your-warehouse-support-primary-keys}
...
### Краткий обзор поддержки первичных ключей в хранилищах {#tldr-on-primary-key-support-across-warehouses}
...
### Первичные ключи в BigQuery {#bigquery-primary-keys}
...
### Первичные ключи в Databricks {#databricks-primary-keys}
...
### Первичные ключи в Redshift {#redshift-primary-keys}
...
### Первичные ключи в Snowflake {#snowflake-primary-keys}
...
### Первичные ключи в Postgres {#postgres-primary-keys}
...
## Начали ли вы тестировать первичные ключи? {#have-you-started-testing-primary-keys-yet}
