...
dbt поставляется со встроенным загрузчиком CSV ([seeds](https://docs.getdbt.com/docs/build/seeds)), который позволяет наполнять ваше хранилище данных любыми файлами, размещёнными в папке `seeds` вашего проекта. Он автоматически определяет типы данных на основе содержимого файлов, но при необходимости вы всегда можете переопределить их, [задав явные инструкции в файле dbt_project.yml](https://docs.getdbt.com/reference/resource-configs/column_types).
