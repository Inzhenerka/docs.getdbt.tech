...
<!--truncate-->
# Гидра заинтересованных сторон {#the-stakeholders-hydra}
...
# Ведущее решение {#the-leading-solution}
...
# Введение в нарративное моделирование {#introducing-narrative-modeling}
...
## Таблицы деталей {#details-tables}
...
# Давайте визуализируем {#lets-get-visual}
...
### Нарративное моделирование {#narrative-modeling}
...
# Преимущества на практике {#benefits-in-practice}

### Заинтересованные стороны находят участие в моделировании данных более простым {#stakeholders-find-it-easier-to-participate-in-data-modeling}
...
### Нематериальные бизнес-шаги легче моделировать {#intangible-business-steps-are-easier-to-model}
...
### Пользователи могут связывать бизнес-концепции с исходными данными {#users-can-tie-business-concepts-to-source-data}
...
# Должна ли ваша команда использовать это? {#should-your-team-use-it}
...
# Бесконечная история {#a-neverending-story}
