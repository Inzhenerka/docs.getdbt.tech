...
<!-- truncate -->
## Defer to prod или предпочесть slog {#defer-to-prod-or-prefer-to-slog}
...
### Встроенная поддержка defer в dbt Cloud {#batteries-included-deferral-in-dbt-cloud}
...
### Другие вещи, которые нужно знать о defer {#other-things-to-to-know-about-defer}
...
### Зовите меня Виллем Дефер {#call-me-willem-defer}
