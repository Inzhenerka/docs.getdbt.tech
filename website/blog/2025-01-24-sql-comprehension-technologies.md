...
## Уровень 1: парсинг {#level-1-parsing}
...
### Промежуточные представления {#intermediate-representations}
...
### Синтаксические деревья {#syntax-trees}
...
## Уровень 2: компиляция {#level-2-compiling}
...
## Уровень 3: исполнение {#level-3-executing}
...
### Оптимизация и планирование {#optimization-and-planning}
