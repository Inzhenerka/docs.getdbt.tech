...
<!--truncate-->
## Что такое `dbt clone`? {#what-is-dbt-clone}
...
### Как это возможно? {#how-is-this-possible}
...
## Чем клонирование отличается от откладывания? {#how-is-cloning-different-from-deferral}
...
## Должен ли я откладывать или клонировать? {#should-i-defer-or-should-i-clone}
...
## Применение на практике {#putting-it-in-practice}
