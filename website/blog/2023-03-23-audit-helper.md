...
## Аудит строк (`compare_queries`) {#audit-rows-compare_queries}
...
### Код для макроса `compare_queries`: пошагово {#the-code-for-the-compare_queries-macro-step-by-step}
...
## Аудит столбцов (`compare_column_values`) {#audit-columns-comparecolumnvalues}
...
### Код для макроса `compare_column_values`: пошагово {#the-code-for-the-comparecolumnvalues-macro-step-by-step}
