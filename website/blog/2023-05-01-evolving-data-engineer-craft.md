...
# Инженеры данных + dbt 1.5: Эволюция мастерства для масштабирования {#data-engineers-dbt-15-evolving-the-craft-for-scale}
...
## Где dbt встречает инженеров данных и куда он движется {#where-dbt-is-meeting-data-engineers-and-where-its-going}
...
### Строим будущее: куда идут инженеры данных с dbt {#building-the-future-where-data-engineers-are-going-with-dbt}
...
## Как выглядит победа с v1.5 для вас, инженера данных? {#what-does-winning-with-v15-look-like-for-you-the-data-engineer}
