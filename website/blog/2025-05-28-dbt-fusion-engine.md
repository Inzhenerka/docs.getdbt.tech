...
## TL;DR: что нужно знать {#tldr-what-you-need-to-know}
...
## Что такое Fusion? {#what-exactly-is-fusion}
...
## Ближайшие преимущества использования Fusion {#near-term-benefits-of-adopting-fusion}
...
### Только новый dbt CLI на базе Fusion {#just-the-new-fusion-powered-dbt-cli}
...
### Новый dbt Fusion CLI + расширение VS Code {#the-new-fusion-powered-dbt-fusion-cli-vs-code-extension}
...
### Как начать работать с Fusion {#how-to-get-started-with-fusion}
