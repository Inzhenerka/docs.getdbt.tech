...
## Почему меня интересует принятие открытого исходного кода {#why-i-care-about-open-source-adoption}
...
## Стек инструментов {#the-tool-stack}
...
## Источники данных и метрики {#data-sources-metrics}
...
## Загрузка необработанных данных в BigQuery {#getting-raw-data-into-bigquery}
...
## Создание моделей данных {#creating-data-models}
...
## Настройка OpenLineage {#configuring-openlineage}
...
## Запуск конвейера {#running-the-pipeline}
