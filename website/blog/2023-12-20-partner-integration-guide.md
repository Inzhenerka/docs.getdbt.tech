...
<!-- truncate -->
## Впервые в dbt Cloud? {#new-to-dbt-cloud}
...
## Хостинг и аутентификация dbt Cloud {#dbt-cloud-hosting-and-authentication}
...
## Потенциальные случаи использования {#potential-use-cases}
...
## Планы и разрешения dbt Cloud {#dbt-cloud-plans-permissions}
