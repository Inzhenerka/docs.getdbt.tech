...
## Ваши имена моделей и опыт ваших конечных пользователей {#your-model-names-and-your-end-users-experience}
...
### Пользовательский опыт аналитика {#the-analysts-user-experience}
...
#### Предварительно вычисленные представления/таблицы в инструменте BI {#precomputed-viewstables-in-a-bi-tool}
...
#### Доступ только для чтения к документации по IDE dbt Cloud {#read-only-access-to-the-dbt-cloud-ide-docs}
...
#### Полный выпадающий список в их хранилище данных. {#the-full-dropdown-list-in-their-data-warehouse}
...
### Пользовательский опыт инженера {#the-engineers-user-experience}
...
#### Внутри инструмента BI {#within-the-bi-tool}
...
#### Внутри хранилища данных {#within-the-data-warehouse}
...
#### Внутри структуры папок Cloud IDE {#within-the-folder-structure-of-cloud-ide}
...
#### Внутри Pull Requests {#within-pull-requests}
...
## Конвенции именования моделей, которые делают всех счастливыми {#model-naming-conventions-that-make-everyone-happy}
...
### Встраивайте информацию в имя, используя согласованный шаблон {#embed-information-in-the-name-using-an-agreed-upon-pattern}
...
#### Используйте формат, такой как `<type/dag_stage>_<source/topic>__<additional_context>`. {#use-a-format-like-___}
