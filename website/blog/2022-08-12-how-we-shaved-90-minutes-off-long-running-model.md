...
## Ваш новый лучший друг: вкладка Model Timing {#your-new-best-friend-the-model-timing-tab}
...
## Определение проблемы {#identifying-the-problem}
...
### Разбор плана запроса {#unpacking-the-query-plan}
...
### Понимание данных {#understanding-the-data}
...
## Переход к решениям {#moving-to-solutions}

### Попытка №1: Оптимизация наших объектов и материализаций {#attempt-1-optimizing-our-objects-and-materializations}
...
### Попытка №2: Переход к инкрементальной модели {#attempt-2-moving-to-an-incremental-model}
...
## Трудности с тестированием {#difficulty-with-testing}
...
## Преимущества улучшения {#benefits-of-the-improvement}
