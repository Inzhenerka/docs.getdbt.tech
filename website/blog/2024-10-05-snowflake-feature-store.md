...
## Что такое признак? {#what-is-a-feature}
...
## Какую роль играет dbt в подготовке данных для моделей ML? {#what-role-does-dbt-play-in-getting-data-ready-for-ml-models}
...
## Кто будет использовать это и какие выгоды они получат? {#who-is-going-to-use-this-and-what-benefits-will-they-see}
...
## Почему мы интегрировали/создали это с Snowflake? {#why-did-we-integratebuild-this-with-snowflake}
...
## Упрощаем ML/Data Engineers работу: и разработку, и деплой ML-данных и моделей {#making-it-easier-for-mldata-engineers-to-both-build-deploy-ml-data-models}
...
## Какие технологии здесь используются? {#what-tech-is-at-play}
...
## Обзор Snowflake ML {#snowflake-ml-overview}
...
## Что нужно сделать, чтобы все это работало? {#what-do-you-need-to-do-to-make-it-all-work}
...
## Как использовать dbt и Snowflake Feature Store для ML-конвейеров {#how-to-power-ml-pipelines-with-dbt-and-snowflakes-feature-store}
...
### Создание таблиц признаков как моделей dbt {#create-feature-tables-as-dbt-models}
...
### Создание или подключение к Snowflake Feature Store {#create-or-connect-to-a-snowflake-feature-store}
...
### Создание и регистрация сущностей признаков {#create-and-register-feature-entities}
...
### Регистрация таблиц признаков как представлений признаков {#register-feature-tables-as-feature-views}
...
### Поиск и обнаружение признаков в интерфейсе Snowflake {#search-and-discover-features-in-the-snowflake-ui}
...
### Генерация обучающего набора данных {#generate-training-dataset}
...
### Обучение и развертывание модели {#train-and-deploy-a-model}
...
### Извлечение признаков для предсказаний {#retrieve-features-for-predictions}
