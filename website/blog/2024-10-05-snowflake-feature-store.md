...
Наконец, dbt Cloud также предоставляет [dbt Explorer](/docs/explore/explore-projects) &mdash; отличный инструмент для каталогизации и распространения знаний об организационных данных между разрозненными командами. dbt Explorer служит централизованным местом для информации о дата‑пайплайнах, включая данные о lineage, свежести данных и их качестве. И самое главное — dbt Explorer обновляется каждый раз при запуске dbt jobs, что гарантирует, что эта информация всегда актуальна и релевантна.
